...
var ECNSRegistry = function () {
  function ECNSRegistry(config) {
    _classCallCheck(this, ECNSRegistry);
    ...
    this.address = '0xb96836a066ef81ea038280c733f833f69c23efde';
    this.registry = new this.web3.eth.Contract(registryABI, this.address);
  }

  _createClass(ECNSRegistry, [{
    key: "getOwner",
